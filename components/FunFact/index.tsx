      ...
      <section className="py-20 lg:py-22.5 px-4 md:px-8 2xl:px-0">
        <div className="mx-auto max-w-c-1390 py-22.5 xl:py-27.5 relative z-1 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:bg-blacksection dark:stroke-strokedark">
          ...
          >
            ...
            This trust is often built upon a track record of consistent performance, reliability, and delivering value that aligns with the high standards and diverse needs of global enterprises.
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Modules</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg lg:text-para2">of Experiance</p>
            </motion.div>
          </div>
        </div>
      </section>
