...
const Hero = () => {
  return (
    <>
      ...
      >
        <div className="container flex flex-wrap pb-8 ">
          <div className="flex items-center w-full lg:w-1/2">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col py-12 items-center justify-start space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                <Link
                  href="/contact"
        ...
        <div>
          <div className="container flex pt-40 flex-col justify-center">
