...
export default function Blogs() {
  return (
    <div>
      <div id="blog" class="bg-gray-100 dark:bg-dark px-4 xl:px-4 py-14">
          ...
          >
            <div class="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8">
              <div tabindex="0" class="focus:outline-none" aria-label="card 1">
                ...
                <div class="bg-white px-10 py-6 rounded-bl-3xl rounded-br-3xl dark:bg-dark">
                  <h1
                    tabindex="0"
              ...
              <div>
                <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                  ...
                  >
                    ...
                    <div class="bg-white px-3 lg:px-6 py-4 rounded-bl-3xl rounded-br-3xl dark:bg-dark">
                      <h1
                        tabindex="0"
                  ...
                  >
                    <img
                      ...
                      role="img"
                      aria-label="gaming"
                      class="focus:outline-none focus:outline-none w-full"
