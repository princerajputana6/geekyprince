      ...
      >
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  We are a team of experienced professionals who specialize in providing top-notch website development solutions to our clients. Our company is dedicated to helping businesses of all sizes and industries succeed online by delivering customized and effective web solutions that meet their unique needs and goals.
                </p>
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/geekyprincerajput/"
                  ...
                  <a
                    href="https://twitter.com/Prince__Rajput_"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.youtube.com/@GeekyPrince"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/company/geeky-prince"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            ...
            Copyright © {new Date().getFullYear()}  <Link href="/">Geeky Prince Pvt. Ltd.</Link>  All rights reserved.
            </p>
          </div>
        </div>
